...
/* {{{ calljava_module_entry */
zend_module_entry calljava_module_entry = {
	STANDARD_MODULE_HEADER,
	"calljava",					/* Extension name */
	ext_functions,					/* zend_function_entry */
	NULL,							/* PHP_MINIT - Module initialization */
	NULL,							/* PHP_MSHUTDOWN - Module shutdown */
	PHP_RINIT(calljava),			/* PHP_RINIT - Request initialization */
	NULL,							/* PHP_RSHUTDOWN - Request shutdown */
	PHP_MINFO(calljava),			/* PHP_MINFO - Module info */
	PHP_CALLJAVA_VERSION,		/* Version */
