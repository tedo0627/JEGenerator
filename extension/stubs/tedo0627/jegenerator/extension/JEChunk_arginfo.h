...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tedo0627_jegenerator_extension_JEChunk_getBlocks, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tedo0627_jegenerator_extension_JEChunk_getBiomes, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEND_METHOD(tedo0627_jegenerator_extension_JEChunk, getBiomes);
...
static const zend_function_entry tedo0627_jegenerator_extension_jechunk_methods[] = {
    ...
    ZEND_ME(tedo0627_jegenerator_extension_JEChunk, getBiomes, arginfo_tedo0627_jegenerator_extension_JEChunk_getBiomes, ZEND_ACC_PUBLIC)
    ZEND_FE_END
};